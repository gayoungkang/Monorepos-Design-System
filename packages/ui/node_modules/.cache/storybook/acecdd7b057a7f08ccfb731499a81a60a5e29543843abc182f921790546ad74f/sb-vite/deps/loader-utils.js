  ...
  "../../node_modules/loader-utils/node_modules/json5/dist/index.js"(exports, module) {
    !(function(u, D) {
      ...
      function I() {
        ...
        if (null !== u2 && "object" === (void 0 === u2 ? "undefined" : i(u2))) B.push(u2), o = Array.isArray(u2) ? "beforeArrayValue" : "beforePropertyName";
        else {
          var e2 = B[B.length - 1];
      ...
      return { parse: function(u2, D2) {
        ...
        return "function" == typeof D2 ? (function u3(D3, e2, F2) {
          var C2 = D3[e2];
          if (null != C2 && "object" === (void 0 === C2 ? "undefined" : i(C2))) if (Array.isArray(C2)) for (var A2 = 0; A2 < C2.length; A2++) {
        ...
        if (null == D2 || "object" !== (void 0 === D2 ? "undefined" : i(D2)) || Array.isArray(D2) || (e2 = D2.space, a2 = D2.quote, D2 = D2.replacer), "function" == typeof D2) n2 = D2;
        ...
        function v2(u3, D3) {
          ...
          return "string" == typeof e3 ? m2(e3) : "number" == typeof e3 ? String(e3) : "object" === (void 0 === e3 ? "undefined" : i(e3)) ? Array.isArray(e3) ? (function(u4) {
            if (F2.indexOf(u4) >= 0) throw TypeError("Converting circular structure to JSON5");
            F2.push(u4);
            var D4 = C2;
            C2 += E2;
        ...
        function p2(u3) {
          if (0 === u3.length) return m2(u3);
          var D3 = String.fromCodePoint(u3.codePointAt(0));
          if (!r(D3)) return m2(u3);
          for (var e3 = D3.length; e3 < u3.length; e3++) if (!t(String.fromCodePoint(u3.codePointAt(e3)))) return m2(u3);
          return u3;
        }
      } };
    });
