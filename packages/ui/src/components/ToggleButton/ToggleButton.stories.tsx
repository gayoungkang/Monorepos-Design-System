...
export const ButtonsVariants: Story = {
  render: (args) => {
    ...
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        {/* Icon Only */}
        <ToggleButton {...args} label="Icon Only" buttons={onlyIconButtons} />

        {/* Icon + Label */}
        <ToggleButton {...args} label="Icon + Label" buttons={iconLabelButtons} />

        {/* Label Only */}
        <ToggleButton {...args} label="Label Only" buttons={onlyLabelButtons} />
      </div>
    )
  },
}
